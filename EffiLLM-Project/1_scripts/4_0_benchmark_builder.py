...
for level in ["Easy", "Medium", "Hard"]:
    for problem in selected[level]:
        ...
        testcase_block = problem.get("small_test_cases") or problem.get("test_case") or ""
...
# === Save to JSON ===
with open("yo_benchmark_testcases.json", "w", encoding="utf-8") as f:
    json.dump(benchmark, f, indent=2)

print("✅ yo_benchmark_testcases.json generated successfully.")
